...
\section*{四、核心代码}
以下代码节选自本实验程序，展示了模型定义与训练评估主体逻辑。The code of this part is available at \footnote{https://github.com/HaoranYuandomestic/ex7\_CNN.git}
...
\begin{figure}[H]
	...
	\IfFileExists{train_loss.png}{
		\includegraphics[width=0.6\textwidth]{train_loss.png}
	}{
